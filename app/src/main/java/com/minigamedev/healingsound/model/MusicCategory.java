...
public class MusicCategory {
    ...
    private void makeMusicCategoryList() {
        ...
        addMusicCategoryList(MusicConst.type.Meditation4.name(), MusicConst.getTypeName(mContext, MusicConst.type.Meditation4),"0");
        addMusicCategoryList(MusicConst.type.Meditation5.name(), MusicConst.getTypeName(mContext, MusicConst.type.Meditation5),"0");
        addMusicCategoryList(MusicConst.type.Meditation6.name(), MusicConst.getTypeName(mContext, MusicConst.type.Meditation6),"0");
        addMusicCategoryList(MusicConst.type.Meditation7.name(), MusicConst.getTypeName(mContext, MusicConst.type.Meditation7),"0");
        addMusicCategoryList(MusicConst.type.Meditation8.name(), MusicConst.getTypeName(mContext, MusicConst.type.Meditation8),"0");
        /*addMusicCategoryList(MusicConst.type.All.name(), MusicConst.getTypeName(mContext, MusicConst.type.All),"1");
